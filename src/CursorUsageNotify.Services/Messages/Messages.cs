...
namespace Larpx.PersonalTools.CursorUsageNotify.Services.Messages
{
    /// <summary>
    /// 后台拉取数据成功后广播，UI 订阅后刷新数据大屏和查询列表。
    /// </summary>
    /// <param name="NewEventsCount">
    /// 本次入库的新事件数。
    /// </param>
    /// <param name="LatestPeriod">
    /// 最新的计费周期汇总。
    /// </param>
    /// <param name="LatestUser">
    /// 最新的用户信息。
    /// </param>
    /// <param name="LatestSubscription">
    /// 最新的订阅信息（含起始日期等）。
    /// </param>
    /// <param name="AggregateStats">
    /// 从 usage_events 表按订阅周期聚合的统计数据。
    /// </param>
    /// <param name="WeeklyAggregateStats">
    /// 本周（周一 00:00 至今）聚合的统计数据。
    /// </param>
