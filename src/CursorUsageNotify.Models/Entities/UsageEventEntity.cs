...
public sealed class UsageEventEntity
{
    ...
    /// <summary>事件发生时间（epoch 毫秒，来自 API 响应 timestamp 字段）。</summary>
    [SugarColumn(ColumnName = "timestamp", IsNullable = false)]
    public long Timestamp { get; set; }

    /// <summary>触发事件的用户邮箱（个人账号场景即当前账号）。</summary>
    [SugarColumn(ColumnName = "user_email", IsNullable = false, Length = 256)]
    public string UserEmail { get; set; } = string.Empty;

    /// <summary>调用的 AI 模型名（如 claude-4.5-sonnet、gpt-5）。</summary>
    [SugarColumn(ColumnName = "model", IsNullable = true, Length = 128)]
    public string? Model { get; set; }

    /// <summary>计费类别（如 Usage-based、Included in Pro）。</summary>
    ...
    /// <summary>请求成本单位（请求计费模式下使用）。</summary>
    ...
    /// <summary>是否为无客户端的后台请求（如 background agents）。</summary>
    ...
    /// <summary>实际计费金额（美分，含 model cost + token fee）。</summary>
    [SugarColumn(ColumnName = "charged_cents")]
    public decimal ChargedCents { get; set; }

    /// <summary>本行入库时间（epoch 毫秒）。</summary>
