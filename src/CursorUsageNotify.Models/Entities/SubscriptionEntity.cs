...
public sealed class SubscriptionEntity
{
    ...
    /// <summary>快照时间（epoch 毫秒，按小时截断作为去重键）。</summary>
    ...
    /// <summary>原始 JSON（保留完整响应）。</summary>
