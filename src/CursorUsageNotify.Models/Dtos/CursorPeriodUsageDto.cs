...
public sealed class CursorPeriodUsageDto
{
    ...
    /// <summary>周期开始（epoch 毫秒），字符串安全转换为 long。</summary>
    [JsonIgnore]
    public long PeriodStartMs => ParseEpochMs(BillingCycleStart);

    /// <summary>周期结束（epoch 毫秒）。</summary>
    [JsonIgnore]
