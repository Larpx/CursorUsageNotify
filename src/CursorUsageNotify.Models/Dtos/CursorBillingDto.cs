...
namespace Larpx.PersonalTools.CursorUsageNotify.Models.Dtos
{
    ...
    /// <summary>
    /// 用户资料详情 DTO，对应 /api/dashboard/get-user-profile.profile 子对象。
    /// </summary>
    ...
    public sealed class CursorSessionsDto
    {
        ...
        /// <summary>
        /// 最近一次 WEB 会话的过期时间（UTC），无会话返回 null。
        /// </summary>
        [JsonIgnore]
    ...
    /// <summary>
    /// 单个会话 DTO，对应 /api/auth/sessions.sessions 数组项。
    /// </summary>
    public sealed class CursorSessionDto
    {
        ...
        /// <summary>
        /// 会话类型（SESSION_TYPE_WEB / SESSION_TYPE_DESKTOP 等）。
        /// </summary>
