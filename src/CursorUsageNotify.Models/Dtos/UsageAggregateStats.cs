...
{
    /// <summary>总 token 数（输入 + 输出）。</summary>
    public long TotalTokens { get; set; }

    /// <summary>总请求数（事件行数）。</summary>
    ...
    /// <summary>按请求成本计费的请求数。</summary>
    public int CostBasedRequests { get; set; }

    /// <summary>聚合起始时间（epoch 毫秒）。</summary>
    public long PeriodStart { get; set; }

    /// <summary>聚合结束时间（epoch 毫秒）。</summary>
    public long PeriodEnd { get; set; }

    /// <summary>聚合范围内的用户邮箱（去重后取第一条）。</summary>
